...
const Navbar = () => {
    ...
    return (
        <>
            <nav className="w-full flex flex-col lg:flex-row space-y-6 lg:space-y-0 relative justify-between items-center h-20 ">

                <Link to={'/'}><img className='w-48' src="https://res.cloudinary.com/dfwmhlhyo/image/upload/v1728887407/boikosh_cwrtzw.png" alt="" /></Link>
